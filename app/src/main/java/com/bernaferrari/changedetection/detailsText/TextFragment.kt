...
class TextFragment : ScopedFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        model.showNotEnoughInfoError.observe(this) {
            if (it == true) {
        ...
        model.showNoChangesDetectedError.observe(this) {
            stateLayout.setEmptyText(R.string.empty_no_change_detected)
            stateLayout.showEmptyState()
        }

        model.showProgress.observe(this) {
            stateLayout.showLoading()
        }
    ...
    private fun fetchData() = launch(Dispatchers.Main) {
        ...
        liveData.observe(this@TextFragment) {
